	...
	menu : {
		...
		scrollDetection : function () {
			$(window).scroll(function () {
				if (ARTUR.variables.scrollTimeout) {
					clearTimeout(ARTUR.variables.scrollTimeout);
